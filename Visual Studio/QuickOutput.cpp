...
void QuickOutput::quick_output_basic_handle(function<void(int*, Mat*, char*, Point*, double*)> puttext_func,
	...
	super::type == IMG ? void(super::dsize = Size(super::img.cols / 6, super::img.rows / 7)) : super::video_written_handle(Size(super::dsize.width * w_enlarge, super::dsize.height * h_enlarge));
	Point point;
	Mat mat, this_mat;
	super::basic_handle([&]() {
